...
*tp++ = gtk_ctree_get_type();
*tp++ = gtk_ctree_line_style_get_type();
*tp++ = gtk_ctree_node_get_type();
...
*tp++ = gtk_file_selection_get_type();
...
*tp++ = gtk_old_editable_get_type();
*tp++ = gtk_option_menu_get_type();
